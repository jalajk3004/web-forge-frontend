      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card shadow-soft border border-border mb-8"
          >
          ...
          <motion.p
            ...
            className="max-w-3xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10"
          >
            WebForge is a modern web development studio that helps startups, founders, 
            and businesses build fast, secure, and high-performance websites and web 
            applications using the latest technologies like Next.js, React, and Node.js.
          </motion.p>
